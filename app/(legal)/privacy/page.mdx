...
### Information we collect from you automatically or from third parties
...
FlowerShop uses your personal information that we collect from you directly, automatically or from third parties to:
...
- Responding to inquiries, complaints and other communications to FlowerShop.
...
Your information is stored and / or processed or otherwise used by or on behalf of FlowerShop. We retain your information for as long as necessary or relevant for the listed purposes in this Privacy Policy, or as required by any applicable legal and retention obligations.
...
- For Canada: Digital Advertising Alliance of Canada Opt-Out Page (FlowerShop is a member of the Digital Advertising Alliance of Canada (DAAC) and we abide by their Self-Regulatory Principles for Online Behavioural Advertising.)
...
You can opt-out on our website here.

To completely opt-out of Interest-Based Advertising with FlowerShop, you need to opt out on both our website, as well as on the Digital Advertising Alliance’s opt-out tool.

Please note that if you opt-out you may still receive online advertising from FlowerShop on other websites or applications; however, these advertisements will not be displayed to you based on your interests. We do not respond to or honor “do not track” (a/k/a DNT) signals or similar mechanisms transmitted by web browsers.

## Your Choices

### Access Request

You can make a request directly to the organization using our services, in which case we will assist as necessary. If you make a request to us, we will let you know what personal information FlowerShop has about you, what it is being used for, and with whom it has been shared. If you notice any inaccuracies or wish to update any part of your personal information, we will look into that as well.

FlowerShop will provide you with access to your personal information that is in our possession, subject to certain exceptions, including information that is referenced to another individual’s personal information that we cannot sever, or information subject to solicitor-client privilege, or other legal restrictions that may prevent us from fulfilling your access request. See below for contact details.

### Residents of the E.U.

Under the General Data Protection Regulations (GDPR), residents of the E.U. also have the right to request of erasure of personal data, right to restrict processing, and in certain circumstances the right to data portability. See below for contact details.

### Residents of California and Other Specific Jurisdictions
...
To exercise the access and deletion rights described above, please submit a request to us by sending an email to privacy@flowermedia.com.
...
To exercise the right to opt-out, you (or your authorized representative) may submit a request to us by sending an email to privacy@flowermedia.com or by clicking Opt-Out at the bottom of this page.
...
In the event you wish to unsubscribe from receiving promotional email communications from FlowerShop you may opt-out by:

- Removing yourself by clicking “unsubscribe” at the bottom of an email we send you, or
- Contact us at: privacy@flowermedia.com
